import { c as create, d as devtools, i as initializeApp, g as getStorage, a as getFirestore, b as ref, u as uploadBytes, e as getDownloadURL, f as addDoc, h as collection, s as serverTimestamp, j as updateDoc, k as doc, q as query, o as orderBy, l as limit, m as getDocs, w as where, n as deleteDoc, F as FFmpeg, p as fetchFile, t as jsxRuntimeExports, v as reactExports, x as reactDomExports, M as Muxer, y as Muxer$1, z as Mp4Muxer, W as WebmMuxer, A as client, R as React } from './vendor-W8QCPF8C.js';
import './vendor-firebase-CCYVATJD.js';
...
async function firebaseUploadOriginals(files, restaurantName, pipelineSessionId) {
  ...
  await Promise.all(
    files.map(
      (m, i) => fbUpload(m.file, `originals/${session}/${i}_${m.file.name}`).catch((e) => console.warn(`[Firebase] ?�일 ${i} ?�로???�패:`, e.message))
    )
  );
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "app-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "header-inner", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "header-version", children: "v2.71" })
      ] }),
