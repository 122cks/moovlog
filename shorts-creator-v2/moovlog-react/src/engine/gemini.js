...
JSON만 반환:
{"audit_report":{"score":93,"reason":""},"title":"","theme":"grill","vibe_color":"#FF6B35","hashtags":"","naver_clip_tags":"","youtube_shorts_tags":"","instagram_caption":"","tiktok_tags":"","marketing":{"hook_title":"","caption":"","hashtags_30":"","receipt_review":""},"hook_variations":[{"type":"shock","caption1":"","caption2":"","narration":""},{"type":"info","caption1":"","caption2":"","narration":""},{"type":"pov","caption1":"","caption2":"","narration":""}],"scenes":[
  {"idx":0,"media_idx":2,"duration":2.2,"caption1":"육증 폭발 🔥","caption2":"숫불향 실화","subtitle_style":"hook","subtitle_position":"center","narration":"","effect":"zoom-out","energy_level":4,"retention_strategy":"opening_question","platform_y_offset":520}
]}`;
  ...
  const makeReq = async url => {
    ...
    // hook_variations 없으면 기본값 카피코피
    if (!obj.hook_variations?.length && obj.scenes?.[0]) {
      const s0 = obj.scenes[0];
      obj.hook_variations = [
        { type: 'shock',  caption1: s0.caption1, caption2: s0.caption2, narration: s0.narration },
        { type: 'info',   caption1: s0.caption1, caption2: '이 집 간다 ✅',  narration: s0.narration },
        { type: 'pov',    caption1: '오늘 여기 어때?', caption2: s0.caption2, narration: s0.narration },
      ];
    }
    return obj;
  };
