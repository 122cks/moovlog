...
• 절대 금지: "~입니다" "~합니다" "~드립니다" 같은 딱딱한 아나운서 말투, 단순한 상황 설명("~하고 있습니다")
...
• 반드시 오감(시각, 청각, 미각, 촉각)을 자극하는 표현을 1개 이상 섞어주세요.
  (예: "지글지글 끓는 소리", "육즙이 팡팡 터지는", "불향이 확 코를 찌르는", "입안에서 사르르 녹는")
...
[팁 #4] 모범 나레이션 예시 — 이 텐션과 길이를 똑같이 따라하세요
- 씬1: "와, 비주얼 미쳤죠? 오늘 소개할 곳은 진짜 나만 알고 싶은 아지트입니다!"
- 씬2: "한 입 먹자마자 숯불향이 입안을 싹 감싸는데, 이거 완전 밥도둑이에요."
- 씬3: "저 영롱한 육즙 보이시나요? 씹을 필요도 없이 사르르 녹아내립니다."

JSON만 반환:
{"title":"제목","hashtags":"#태그","naver_clip_tags":"#협찬 #서울맛집","youtube_shorts_tags":"#맛집 #shorts","instagram_caption":"소개문\\n\\n#태그","tiktok_tags":"#맛집","scenes":[
  {"idx":0,"media_idx":2,"duration":3.0,"caption1":"한우 채끝","caption2":"불향 살아있어요","subtitle_style":"hook","subtitle_position":"center","narration":"두툼하게 썰어낸 한우 채끝, 육즙이 팡팡 터져요!","effect":"zoom-out"}
]}`;

  const makeReq = async url => {
    const body = {
      system_instruction: {
        parts: [{ text: "당신은 트렌디하고 텐션 높은 2030 맛집 크리에이터 '무브먼트(moovlog)'입니다. 절대 AI나 로봇처럼 말하지 말고, 친한 친구에게 호들갑 떨며 맛집을 추천하는 자연스러운 구어체만 사용하세요." }],
      },
